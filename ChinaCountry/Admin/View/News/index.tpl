...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method="post" action="{:U('News/index')}" role="search" class="navbar-form navbar-left">
        ...
        <table class="table tableW">
            <tr>
                <th class="th" colspan="6">新闻列表 | <a href="{:U('News/add')}">添加新闻</a></th>
            </tr>
            <tr class="tableTop">
            ...
            <foreach name="news" key="key" item="tmp">
                <tr>
                    ...
                    <td class="text_left">
                        ...
                        <a href="javascript:void 0;" name="delete" id="{$tmp['id']}" class="orange del">删除</a>
                    </td>
                </tr>
            </foreach>
        </table>
