...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="__PUBLIC__/Admin/iconfont/iconfont.css" rel="stylesheet" />
        <link href="__PUBLIC__/Admin/css/logForm.css" rel="stylesheet" />
        <script src="__PUBLIC__/Admin/js/jquery-1.9.1.min.js"></script>
        <!-- 引入封装了failback的接口--initGeetest -->
        <script src="__PUBLIC__/Admin/js/failback.js"></script>

    </head>
    <body style="background:url(__PUBLIC__/Admin/Images/bsl1.jpg);">
        <div class="charLogin">
            <<< 后台管理登录
        </div>
