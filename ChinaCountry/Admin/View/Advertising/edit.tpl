    ...
    <body>
        <form method='post' action='__URL__/update' enctype="multipart/form-data">
            <table class="table tableW">
                <tr >
                    <td class="th" colspan="2">更改成绩单 | <a href="__URL__/index">上级</a></td>
                    <input type="hidden" name="id" value="{$Advertising['id']}">
                </tr>
                <tr>
                    <td>标题：</td>
                    <td class='text_left'><input class="form-control input-sm inputw" type="text" name="title" value="{$Advertising['title']}"/></td>
                </tr>
                <tr>
                    <td>图片：</td>
                    <td>
                ...
                <tr>
                    <td>外链：</td>
                    <td class='text_left'><input class="form-control input-sm inputw" type="text" name="hret" value="{$Advertising['hret']}"/></td>
                </tr>
                <tr>
