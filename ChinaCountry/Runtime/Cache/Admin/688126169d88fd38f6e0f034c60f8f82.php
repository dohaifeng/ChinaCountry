...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method='post' action='/chinacountry/index.php/admin/settings/update.html'>
            <table class="table tableW">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='title' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;">CCTV 《美丽中国乡村行》 栏目官方网站</textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='keyword' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;">美丽中国乡村行,CCTV美丽中国乡村行,CCTV7美丽中国乡村行,中央电视台美丽中国乡村行栏目</textarea>
                            </div>
                        </div>
                    </td>
                </tr>                        
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='description' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;">《美丽中国乡村行》栏目官方网站，提供CCTV7《美丽中国乡村行》栏目视频预告、点播、栏目动态等内容。</textarea>
                            </div>
                        </div>
                    </td>
                </tr>
