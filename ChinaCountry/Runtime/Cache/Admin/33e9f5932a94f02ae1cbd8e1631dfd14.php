    ...
    <body>
        <table class="table tableW">
            ...
            <tr>
                        ...
                        <!-- <input type="checkbox"   groupid="1"  value="1" checked />查看用户 -->
                                ...
                                <label class="checkbox checkboxW" for="027">
                                    <input type="checkbox" groupid="1" value="27" checked id="027" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        编辑分类                                </label>
                                                            <br /><!-- <input type="checkbox"   groupid="1"  value="28" checked />查看新闻 -->
                                <label class="checkbox checkboxW" for="028">
                                    <input type="checkbox" groupid="1" value="28" checked id="028" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看新闻                                </label>
                                                            <!-- <input type="checkbox"   groupid="1"  value="29" checked />添加新闻 -->
                                <label class="checkbox checkboxW" for="029">
                                    <input type="checkbox" groupid="1" value="29" checked id="029" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加新闻                                </label>
                                                            <!-- <input type="checkbox"   groupid="1"  value="30" checked />编辑新闻 -->
                                ...
                                <label class="checkbox checkboxW" for="032">
                                    <input type="checkbox" groupid="1" value="32" checked id="032" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        添加视频                                </label>
                                                            <br /><!-- <input type="checkbox"   groupid="1"  value="33" checked />编辑视频 -->
                                <label class="checkbox checkboxW" for="033">
                                    <input type="checkbox" groupid="1" value="33" checked id="033" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑视频                                </label>
                                                            <!-- <input type="checkbox"   groupid="1"  value="34" checked />查看轮播图 -->
                                <label class="checkbox checkboxW" for="034">
                                    <input type="checkbox" groupid="1" value="34" checked id="034" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看轮播图                                </label>
                                                            <!-- <input type="checkbox"   groupid="1"  value="35" checked />添加轮播图 -->
                                <label class="checkbox checkboxW" for="035">
                                    <input type="checkbox" groupid="1" value="35" checked id="035" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加轮播图                                </label>
                                                            <!-- <input type="checkbox"   groupid="1"  value="36" checked />编辑轮播图 -->
                    ...
                    <td valign="top"><a href="javascript:del(19);" class="remove"></a><br />2</td>
                    <td valign="top"> <a href="javascript:void 0;" groupid="19" class="edit"></a><br /><span>超级用户</span> </td>
                    <td class="text_left">
                        <!-- <input type="checkbox"   groupid="19"  value="1" checked />查看用户 -->
                                <label class="checkbox checkboxW" for="11">
                                    <input type="checkbox" groupid="19" value="1" checked id="11" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看用户                                </label>
                                                                                            <!-- <input type="checkbox"    groupid="19"  value="2" />添加用户 -->
                                <label class="checkbox checkboxW" for="12">
                                    <input type="checkbox" groupid="19" value="2" id="12" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加用户                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="3" />插入用户 -->
                                <label class="checkbox checkboxW" for="13">
                                    <input type="checkbox" groupid="19" value="3" id="13" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        插入用户                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="4" />编辑用户 -->
                                <label class="checkbox checkboxW" for="14">
                                    <input type="checkbox" groupid="19" value="4" id="14" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑用户                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="5" />修改用户 -->
                                <label class="checkbox checkboxW" for="15">
                                    <input type="checkbox" groupid="19" value="5" id="15" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        修改用户                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="6" />删除用户 -->
                                <label class="checkbox checkboxW" for="16">
                                    <input type="checkbox" groupid="19" value="6" id="16" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        删除用户                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="7" />查看分组角色 -->
                                <label class="checkbox checkboxW" for="17">
                                    <input type="checkbox" groupid="19" value="7" id="17" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看分组角色                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="20" />修改分组权限 -->
                                <label class="checkbox checkboxW" for="120">
                                    <input type="checkbox" groupid="19" value="20" id="120" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        修改分组权限                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="9" />编辑分组角色显示名 -->
                                <label class="checkbox checkboxW" for="19">
                                    <input type="checkbox" groupid="19" value="9" id="19" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑分组角色显示名                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="10" />修改分组角色显示名 -->
                                <label class="checkbox checkboxW" for="110">
                                    <input type="checkbox" groupid="19" value="10" id="110" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        修改分组角色显示名                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="11" />添加角色分组 -->
                                <label class="checkbox checkboxW" for="111">
                                    <input type="checkbox" groupid="19" value="11" id="111" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加角色分组                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="12" />插入角色分组 -->
                                <label class="checkbox checkboxW" for="112">
                                    <input type="checkbox" groupid="19" value="12" id="112" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        插入角色分组                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="13" />删除角色分组 -->
                                <label class="checkbox checkboxW" for="113">
                                    <input type="checkbox" groupid="19" value="13" id="113" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        删除角色分组                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="14" />查看权限 -->
                                <label class="checkbox checkboxW" for="114">
                                    <input type="checkbox" groupid="19" value="14" id="114" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看权限                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="15" />添加权限 -->
                                <label class="checkbox checkboxW" for="115">
                                    <input type="checkbox" groupid="19" value="15" id="115" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加权限                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="16" />插入权限 -->
                                <label class="checkbox checkboxW" for="116">
                                    <input type="checkbox" groupid="19" value="16" id="116" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        插入权限                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="17" />编辑权限 -->
                                <label class="checkbox checkboxW" for="117">
                                    <input type="checkbox" groupid="19" value="17" id="117" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑权限                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="18" />修改权限 -->
                                <label class="checkbox checkboxW" for="118">
                                    <input type="checkbox" groupid="19" value="18" id="118" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        修改权限                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="19" />权限操作 -->
                                <label class="checkbox checkboxW" for="119">
                                    <input type="checkbox" groupid="19" value="19" id="119" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        权限操作                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="21" />设置用户角色 -->
                                <label class="checkbox checkboxW" for="121">
                                    <input type="checkbox" groupid="19" value="21" id="121" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        设置用户角色                                </label>                            <br /><!-- <input type="checkbox"   groupid="19"  value="23" checked />查看备份 -->
                                <label class="checkbox checkboxW" for="123">
                                    <input type="checkbox" groupid="19" value="23" checked id="123" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看备份                                </label>
                                                                                            <!-- <input type="checkbox"    groupid="19"  value="24" />添加备份 -->
                                <label class="checkbox checkboxW" for="124">
                                    <input type="checkbox" groupid="19" value="24" id="124" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加备份                                </label>                            <!-- <input type="checkbox"   groupid="19"  value="25" checked />查看分类 -->
                                <label class="checkbox checkboxW" for="125">
                                    <input type="checkbox" groupid="19" value="25" checked id="125" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看分类                                </label>
                                                                                            <!-- <input type="checkbox"    groupid="19"  value="26" />添加分类 -->
                                <label class="checkbox checkboxW" for="126">
                                    <input type="checkbox" groupid="19" value="26" id="126" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加分类                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="27" />编辑分类 -->
                                <label class="checkbox checkboxW" for="127">
                                    <input type="checkbox" groupid="19" value="27" id="127" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑分类                                </label>                            <br /><!-- <input type="checkbox"   groupid="19"  value="28" checked />查看新闻 -->
                                <label class="checkbox checkboxW" for="128">
                                    <input type="checkbox" groupid="19" value="28" checked id="128" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看新闻                                </label>
                                                                                            <!-- <input type="checkbox"    groupid="19"  value="29" />添加新闻 -->
                                <label class="checkbox checkboxW" for="129">
                                    <input type="checkbox" groupid="19" value="29" id="129" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加新闻                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="30" />编辑新闻 -->
                                <label class="checkbox checkboxW" for="130">
                                    <input type="checkbox" groupid="19" value="30" id="130" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑新闻                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="31" />查看视频 -->
                                <label class="checkbox checkboxW" for="131">
                                    <input type="checkbox" groupid="19" value="31" id="131" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看视频                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="32" />添加视频 -->
                                <label class="checkbox checkboxW" for="132">
                                    <input type="checkbox" groupid="19" value="32" id="132" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加视频                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="33" />编辑视频 -->
                                <label class="checkbox checkboxW" for="133">
                                    <input type="checkbox" groupid="19" value="33" id="133" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑视频                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="34" />查看轮播图 -->
                                <label class="checkbox checkboxW" for="134">
                                    <input type="checkbox" groupid="19" value="34" id="134" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看轮播图                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="35" />添加轮播图 -->
                                <label class="checkbox checkboxW" for="135">
                                    <input type="checkbox" groupid="19" value="35" id="135" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加轮播图                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="36" />编辑轮播图 -->
                                <label class="checkbox checkboxW" for="136">
                                    <input type="checkbox" groupid="19" value="36" id="136" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
