                ...
                <tr>
                        <td>
                            <label class="checkbox" for="checkbox35">
                                <input type="checkbox" name='ids[]' value="35" id="checkbox35" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                        ...
                        <td>Advertising/add</td>
                        <td>添加轮播图</td>
                        <td>
                             
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="35" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox36">
                                <input type="checkbox" name='ids[]' value="36" id="checkbox36" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>Advertising/edit</td>
                        <td>编辑轮播图</td>
                        <td>
                             
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="36" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox34">
                                <input type="checkbox" name='ids[]' value="34" id="checkbox34" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="34" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                        ...
                        <td>
                            <label class="checkbox" for="checkbox29">
                                <input type="checkbox" name='ids[]' value="29" id="checkbox29" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="29" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox30">
                                <input type="checkbox" name='ids[]' value="30" id="checkbox30" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="30" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox28">
                                <input type="checkbox" name='ids[]' value="28" id="checkbox28" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="28" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                        ...
                        <td>
                            <label class="checkbox" for="checkbox32">
                                <input type="checkbox" name='ids[]' value="32" id="checkbox32" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="32" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox33">
                                <input type="checkbox" name='ids[]' value="33" id="checkbox33" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="33" value="编辑" class="blue" /></td>
                    </tr><tr>
                        <td>
                            <label class="checkbox" for="checkbox31">
                                <input type="checkbox" name='ids[]' value="31" id="checkbox31" data-toggle="checkbox" class="custom-checkbox">
                                    <span class="icons">
                                        <span class="icon-unchecked colorGray"></span>
                                        <span class="icon-checked colorGreen"></span>
                                    </span>
                        ...
                        <td>
                                ...
                                <font color="red">禁用</font>                        </td>
                        <td><input type="button" aid="31" value="编辑" class="blue" /></td>
                    </tr>            </form>
        </table>
    </body>
