<?php if (!defined('THINK_PATH')) exit();?><link rel="stylesheet" href="/chinacountry/Public/Admin/css/public.css">
...
<form method="post">
    ...
    <table class="table table-striped table-bordered table-hover tableW">
        <tr>
            ...
            <td><input name="name" value="<?php echo ($time); ?>" type="text" class="form-control" id="inputEmail3" placeholder=""></td>
        </tr>
        <tr>
