                        ...
                        <!-- <input type="checkbox"   groupid="19"  value="1" checked />查看用户 -->
                                ...
                                <label class="checkbox checkboxW" for="121">
                                    <input type="checkbox" groupid="19" value="21" id="121" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        设置用户角色                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="23" />查看备份 -->
                                <label class="checkbox checkboxW" for="123">
                                    <input type="checkbox" groupid="19" value="23" id="123" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看备份                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="24" />添加备份 -->
                                <label class="checkbox checkboxW" for="124">
                                    <input type="checkbox" groupid="19" value="24" id="124" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        添加备份                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="25" />查看分类 -->
                                <label class="checkbox checkboxW" for="125">
                                    <input type="checkbox" groupid="19" value="25" id="125" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看分类                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="26" />添加分类 -->
                                ...
                                <label class="checkbox checkboxW" for="127">
                                    <input type="checkbox" groupid="19" value="27" id="127" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        编辑分类                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="19"  value="28" />查看新闻 -->
                                <label class="checkbox checkboxW" for="128">
                                    <input type="checkbox" groupid="19" value="28" id="128" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看新闻                                </label>                                                            <!-- <input type="checkbox"    groupid="19"  value="29" />添加新闻 -->
