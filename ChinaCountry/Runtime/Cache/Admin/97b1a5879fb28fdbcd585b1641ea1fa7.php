        ...
        <form method='post' action='/chinacountry/index.php/Admin/Column/Update'>
            <table class="table tableW">
                ...
                <tr>
                    <td>栏目名称：</td>
                    <td>
                        <input class="form-control input-sm inputw" type='text' name='name' value='精彩预告1' />
                    </td>
                </tr>                        
                <tr>
                    <td>栏目链接：</td>
                    <td><input class="form-control input-sm inputw" type='text' name='url' value='foreshow/index'/></td>
                </tr>
                <tr>
