...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method="post" action="<?php echo U('News/index');?>" role="search" class="navbar-form navbar-left">
        ...
        <table class="table tableW">
            <tr>
                <th class="th" colspan="6">新闻列表 | <a href="<?php echo U('News/add');?>">添加新闻</a></th>
            </tr>
            <tr class="tableTop">
            ...
            <?php if(is_array($news)): foreach($news as $key=>$tmp): ?><tr>
                    ...
                    <td class="text_left">
                        ...
                        <a href="/chinacountry/index.php/Admin/News/edit/id/<?php echo ($tmp['id']); ?>" class="blue">编辑</a>
                        <a href="javascript:void 0;" name="delete" id="<?php echo ($tmp['id']); ?>" class="orange del">删除</a>
                    </td>
