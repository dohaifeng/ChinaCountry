...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <table class="table tableW">
                ...
                <tr>
                    <td class="th" colspan="5">类别列表 | <a class="colorBlue" href='/chinacountry/index.php/admin/settings/add.html'>添加信息</a></td>
                </tr>
            <tr class="tableTop">
            ...
            <tr>
                    ...
                    <td class="paddingTop2">测试2</td>
                    <td class="paddingTop2">测试3</td>
                    <td class="text_left">
                        <a href="/chinacountry/index.php/admin/settings/edit/id/2.html" class="blue">编辑</a>
