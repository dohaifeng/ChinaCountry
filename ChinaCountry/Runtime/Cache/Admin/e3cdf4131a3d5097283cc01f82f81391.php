    ...
    <body>
        <form method='post' action='/chinacountry/index.php/Admin/User/Update'>
            <table class="table tableW">
                ...
                <tr>
                    <td>用户名：</td>
                    <td><input class="form-control input-sm inputw" type='text' name='uname' value='admin' disabled /></td>
                </tr>
                <tr>
                    <td>昵称：</td>
                    <td><input class="form-control input-sm inputw" type='text' name='nickname' value='柚子' /></td>
                </tr>                        
                <tr>
                    <td>密码：</td>
                ...
                <tr>
                    ...
                    <td class='text_left'>
                        <select class="form-control select select-primary select-block" name="group_id">
                            <option class="option" value="1" selected>管理员</option>
                                                                        <option class="option" value="8">超级用户</option>                                    <option class="option" value="10">普通用户</option>                        </select>
                    </td>
                </tr>
                <tr>
                    <td>上次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='logined' value='2016-08-18 10:46:33'disabled /></td>
                </tr>
                <tr>
                    <td>本次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='login' value='2016-08-18 13:08:48' disabled /></td>
                </tr>
                <tr>
                    <td>登陆次数</td>
                    <td><input class="form-control input-sm inputw" type='text' name='times' value='1970-01-01 08:00:28' disabled /></td>
                </tr>
                <tr>
