        ...
        <nav class="hLeft visible-sm-block visible-lg-block visible-md-block">
            ...
            <ul class="navList">
                ...
                <li>
                    <div>
                        <div class="maskDiv"></div>
                        <span class="iconfont icon-shezhi" data-toggle="right" data-original-title="用户管理"></span>
                        <span>用户管理</span>
                       <span class="iconfont icon-jia"></span>
                    </div>
                    <ul class="children">
                    ...
                    <ul class="children">
                        <li>
                            <div data-toggle="cxmanage" data-toggle-children="couponManages">
                                ...
                                <a href="/chinacountry/index.php/admin/bak/index.html" class="pos" data-name="设置站点介绍"><span>设置站点介绍</span></a>
                            </div>
                        </li>
                        <li>
                            <div data-toggle="cxmanage" data-toggle-children="couponManages">
    ...
    <body>
        <table class="table tableW">
            ...
            <tr>
                ...
                <td class="td1">2016-08-23 14:25:21</td>
            </tr>
            <tr>
                <td class="td2">上次登录时间</td>
                <td class="td1">2016-08-22 11:11:09</td>
            </tr>
            <tr>
                <td class="td2">累计登录</td>
                <td class="td1">36 次</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td1">WINNT</td>
            </tr>
            <tr>
                <td class="td2">运行环境</td>
                <td class="td1">Apache/2.4.4 (Win32) PHP/5.4.16</td>
            </tr>        
            <tr>
                <td class="td2">服务器时间</td>
                <td class="td1">2016年8月24日 10:21:53</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td1">localhost [ 127.0.0.1 ]</td>
            </tr>
            <tr>
                <td class="td2">上传附件限制</td>
                <td class="td1">1048576M</td>
            </tr>
            <tr>
