...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method='post' action='/chinacountry/index.php/Admin/Settings/Update'>
            <table class="table tableW">
                ...
                <tr>
                    <td>用户名：</td>
                    <td><input class="form-control input-sm inputw" type='text' name='name' value='' disabled /></td>
                </tr>
                <tr>
                    <td>昵称：</td>
                    <td><input class="form-control input-sm inputw" type='text' name='nickname' value='' /></td>
                </tr>                        
                <tr>
                    <td>密码：</td>
                ...
                <tr>
                    <td>上次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='logined' value='2016-08-24 14:16:52'disabled /></td>
                </tr>
                <tr>
                    <td>本次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='login' value='2016-08-24 14:16:52' disabled /></td>
                </tr>
                <tr>
                    <td>登陆次数</td>
                    <td><input class="form-control input-sm inputw" type='text' name='times' value='2016-08-24 14:16:52' disabled /></td>
                </tr>
                <tr>
