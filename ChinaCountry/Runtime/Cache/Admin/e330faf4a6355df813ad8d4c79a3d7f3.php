...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method="post" action="/chinacountry/index.php/admin/advertising/index.html" role="search" class="navbar-form navbar-left">
            <div class="form-group">
                <input type="text" name="keyword" value="" onfocus="javascript:if (this.value === '')
        ...
        <table class="table tableW">
            ...
            <tr>
                    <td>测试</td>
                    <td><img src="/chinacountry/Uploads/2016-08-16/imge/57b2a1745c5b7.jpg" width="90" ></td>
                    <td class='text_left'>
                        <a href="/chinacountry/index.php/Admin/Advertising/edit/id/3" class="blue">修改</a>
                        <a href="javascript:void 0;" name="delete" id="3" class="orange">删除</a>
                    </td>
                </tr><tr>
                    <td>视频2</td>
                    <td><img src="/chinacountry/Uploads/2016-08-16/imge/57b2a19d54627.jpg" width="90" ></td>
                    <td class='text_left'>
                        <a href="/chinacountry/index.php/Admin/Advertising/edit/id/4" class="blue">修改</a>
