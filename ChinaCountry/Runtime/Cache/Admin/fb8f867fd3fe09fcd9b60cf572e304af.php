...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method='post' action='<?php echo U("Settings/update");?>'>
            <table class="table tableW">
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='title' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;"><?php echo ($edit["0"]["title"]); ?></textarea>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='keyword' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;"><?php echo ($edit["0"]["keyword"]); ?></textarea>
                            </div>
                        </div>
                    </td>
                </tr>                        
                <tr>
                    ...
                    <td>
                        <div class="form-group clearfix">
                            <div class="demo-col">
                                <textarea class="form-control" name='description' rows="3" style="margin: 0px -5px 0px 0px; width: 300px; height: 86px;"><?php echo ($edit["0"]["description"]); ?></textarea>
                            </div>
                        </div>
                    </td>
                </tr>
