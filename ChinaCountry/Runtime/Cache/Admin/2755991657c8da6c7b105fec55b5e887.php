...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <form method="post" action="/chinacountry/index.php/admin/news/index.html" role="search" class="navbar-form navbar-left">
        ...
        <table class="table tableW">
            <tr>
                <th class="th" colspan="6">新闻列表 | <a href="/chinacountry/index.php/admin/news/add.html">添加新闻</a></th>
            </tr>
            <tr class="tableTop">
            ...
            <tr>
                    ...
                    <td class="paddingTop2">首页大图3</td>
                    <td class="paddingTop2">2016年08月12日</td>
                    <td class="paddingTop2">0</td>
                    <td class="text_left">
                        <!-- <a href="/chinacountry/index.php/home/content/index/id/2.html" target="_Blank" class="blue">查看详情</a> -->
                        <a href="/chinacountry/index.php/Admin/News/edit/id/2" class="blue">编辑</a>
                        <a href="javascript:void 0;" name="delete" id="2" class="orange del">删除</a>
                    </td>
                </tr><tr>
                    ...
                    <td class="paddingTop2">0</td>
                    <td class="text_left">
                        <!-- <a href="/chinacountry/index.php/home/content/index/id/1.html" target="_Blank" class="blue">查看详情</a> -->
                        <a href="/chinacountry/index.php/Admin/News/edit/id/1" class="blue">编辑</a>
                        <a href="javascript:void 0;" name="delete" id="1" class="orange del">删除</a>
                    </td>
                </tr>        </table>
        <div class="page"><div>    </div></div>
    </body>

    <script src="/chinacountry/Public/Admin/js/public.js"></script>
</html>
        </div>
    </div>
<script>
