    ...
    <body>
        <table class="table tableW">
            ...
            <tr>
                    ...
                    <td valign="top"><a href="javascript:del(16);" class="remove"></a><br />2</td>
                    ...
                    <td class="text_left">
                                ...
                                <label class="checkbox checkboxW" for="11">
                                    <input type="checkbox" groupid="16" value="1" id="11" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="12">
                                    <input type="checkbox" groupid="16" value="2" id="12" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="13">
                                    <input type="checkbox" groupid="16" value="3" id="13" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="14">
                                    <input type="checkbox" groupid="16" value="4" id="14" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="15">
                                    <input type="checkbox" groupid="16" value="5" id="15" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="16">
                                    <input type="checkbox" groupid="16" value="6" id="16" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="17">
                                    <input type="checkbox" groupid="16" value="7" id="17" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="120">
                                    <input type="checkbox" groupid="16" value="20" id="120" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="19">
                                    <input type="checkbox" groupid="16" value="9" id="19" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="110">
                                    <input type="checkbox" groupid="16" value="10" id="110" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="111">
                                    <input type="checkbox" groupid="16" value="11" id="111" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="112">
                                    <input type="checkbox" groupid="16" value="12" id="112" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="113">
                                    <input type="checkbox" groupid="16" value="13" id="113" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="114">
                                    <input type="checkbox" groupid="16" value="14" id="114" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="115">
                                    <input type="checkbox" groupid="16" value="15" id="115" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="116">
                                    <input type="checkbox" groupid="16" value="16" id="116" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="117">
                                    <input type="checkbox" groupid="16" value="17" id="117" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="118">
                                    <input type="checkbox" groupid="16" value="18" id="118" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="119">
                                    <input type="checkbox" groupid="16" value="19" id="119" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="121">
                                    <input type="checkbox" groupid="16" value="21" id="121" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="123">
                                    <input type="checkbox" groupid="16" value="23" id="123" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="124">
                                    <input type="checkbox" groupid="16" value="24" id="124" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="125">
                                    <input type="checkbox" groupid="16" value="25" id="125" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="126">
                                    <input type="checkbox" groupid="16" value="26" id="126" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="127">
                                    <input type="checkbox" groupid="16" value="27" id="127" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="128">
                                    <input type="checkbox" groupid="16" value="28" id="128" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="129">
                                    <input type="checkbox" groupid="16" value="29" id="129" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="130">
                                    <input type="checkbox" groupid="16" value="30" id="130" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="131">
                                    <input type="checkbox" groupid="16" value="31" id="131" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="132">
                                    <input type="checkbox" groupid="16" value="32" id="132" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="133">
                                    <input type="checkbox" groupid="16" value="33" id="133" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="134">
                                    <input type="checkbox" groupid="16" value="34" id="134" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="135">
                                    <input type="checkbox" groupid="16" value="35" id="135" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="136">
                                    <input type="checkbox" groupid="16" value="36" id="136" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                    ...
                    <td valign="top"><a href="javascript:del(17);" class="remove"></a><br />3</td>
                    ...
                    <td class="text_left">
                                ...
                                <label class="checkbox checkboxW" for="21">
                                    <input type="checkbox" groupid="17" value="1" id="21" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="22">
                                    <input type="checkbox" groupid="17" value="2" id="22" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="23">
                                    <input type="checkbox" groupid="17" value="3" id="23" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="24">
                                    <input type="checkbox" groupid="17" value="4" id="24" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="25">
                                    <input type="checkbox" groupid="17" value="5" id="25" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="26">
                                    <input type="checkbox" groupid="17" value="6" id="26" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="27">
                                    <input type="checkbox" groupid="17" value="7" id="27" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="220">
                                    <input type="checkbox" groupid="17" value="20" id="220" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="29">
                                    <input type="checkbox" groupid="17" value="9" id="29" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="210">
                                    <input type="checkbox" groupid="17" value="10" id="210" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="211">
                                    <input type="checkbox" groupid="17" value="11" id="211" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="212">
                                    <input type="checkbox" groupid="17" value="12" id="212" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="213">
                                    <input type="checkbox" groupid="17" value="13" id="213" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="214">
                                    <input type="checkbox" groupid="17" value="14" id="214" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="215">
                                    <input type="checkbox" groupid="17" value="15" id="215" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="216">
                                    <input type="checkbox" groupid="17" value="16" id="216" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="217">
                                    <input type="checkbox" groupid="17" value="17" id="217" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="218">
                                    <input type="checkbox" groupid="17" value="18" id="218" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="219">
                                    <input type="checkbox" groupid="17" value="19" id="219" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="221">
                                    <input type="checkbox" groupid="17" value="21" id="221" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="223">
                                    <input type="checkbox" groupid="17" value="23" id="223" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="224">
                                    <input type="checkbox" groupid="17" value="24" id="224" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="225">
                                    <input type="checkbox" groupid="17" value="25" id="225" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="226">
                                    <input type="checkbox" groupid="17" value="26" id="226" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="227">
                                    <input type="checkbox" groupid="17" value="27" id="227" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="228">
                                    <input type="checkbox" groupid="17" value="28" id="228" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="229">
                                    <input type="checkbox" groupid="17" value="29" id="229" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="230">
                                    <input type="checkbox" groupid="17" value="30" id="230" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="231">
                                    <input type="checkbox" groupid="17" value="31" id="231" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="232">
                                    <input type="checkbox" groupid="17" value="32" id="232" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="233">
                                    <input type="checkbox" groupid="17" value="33" id="233" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="234">
                                    <input type="checkbox" groupid="17" value="34" id="234" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="235">
                                    <input type="checkbox" groupid="17" value="35" id="235" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="236">
                                    <input type="checkbox" groupid="17" value="36" id="236" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                    ...
                    <td valign="top"><a href="javascript:del(18);" class="remove"></a><br />4</td>
                    ...
                    <td class="text_left">
                        <!-- <input type="checkbox"   groupid="18"  value="1" checked />查看用户 -->
                                <label class="checkbox checkboxW" for="31">
                                    <input type="checkbox" groupid="18" value="1" checked id="31" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="32">
                                    <input type="checkbox" groupid="18" value="2" checked id="32" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="33">
                                    <input type="checkbox" groupid="18" value="3" checked id="33" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="34">
                                    <input type="checkbox" groupid="18" value="4" checked id="34" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="35">
                                    <input type="checkbox" groupid="18" value="5" checked id="35" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="36">
                                    <input type="checkbox" groupid="18" value="6" checked id="36" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="37">
                                    <input type="checkbox" groupid="18" value="7" checked id="37" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="320">
                                    <input type="checkbox" groupid="18" value="20" checked id="320" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="39">
                                    <input type="checkbox" groupid="18" value="9" checked id="39" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="310">
                                    <input type="checkbox" groupid="18" value="10" checked id="310" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="311">
                                    <input type="checkbox" groupid="18" value="11" checked id="311" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="312">
                                    <input type="checkbox" groupid="18" value="12" checked id="312" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="313">
                                    <input type="checkbox" groupid="18" value="13" checked id="313" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="314">
                                    <input type="checkbox" groupid="18" value="14" checked id="314" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="315">
                                    <input type="checkbox" groupid="18" value="15" checked id="315" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="316">
                                    <input type="checkbox" groupid="18" value="16" checked id="316" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="317">
                                    <input type="checkbox" groupid="18" value="17" checked id="317" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="318">
                                    <input type="checkbox" groupid="18" value="18" checked id="318" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="319">
                                    <input type="checkbox" groupid="18" value="19" checked id="319" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="321">
                                    <input type="checkbox" groupid="18" value="21" checked id="321" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="323">
                                    <input type="checkbox" groupid="18" value="23" checked id="323" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="324">
                                    <input type="checkbox" groupid="18" value="24" checked id="324" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="325">
                                    <input type="checkbox" groupid="18" value="25" checked id="325" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="326">
                                    <input type="checkbox" groupid="18" value="26" checked id="326" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="327">
                                    <input type="checkbox" groupid="18" value="27" checked id="327" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="328">
                                    <input type="checkbox" groupid="18" value="28" checked id="328" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="329">
                                    <input type="checkbox" groupid="18" value="29" checked id="329" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="330">
                                    <input type="checkbox" groupid="18" value="30" checked id="330" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="331">
                                    <input type="checkbox" groupid="18" value="31" checked id="331" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="332">
                                    <input type="checkbox" groupid="18" value="32" checked id="332" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="333">
                                    <input type="checkbox" groupid="18" value="33" checked id="333" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="334">
                                    <input type="checkbox" groupid="18" value="34" id="334" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="335">
                                    <input type="checkbox" groupid="18" value="35" id="335" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                ...
                                <label class="checkbox checkboxW" for="336">
                                    <input type="checkbox" groupid="18" value="36" id="336" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
