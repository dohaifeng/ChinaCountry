        ...
        <form action="/chinacountry/index.php/Admin/Video/update" method="post" enctype="multipart/form-data">
            ...
            <table class="table tableW">
                ...
                <tr>
                    ...
                    <td><input class="form-control input-sm inputw" type="text" name="title" value="测试1"/></td>
                </tr>
                <tr>
                    <td class="colorBlack">所属分类：</td>
                    <td class='text_left'>
                        <select class="form-control select select-primary select-block" name="column_id">
                            <option value="1" selected>精彩预告</option>
                                                                        <option value="2">视频点播</option>                        </select>
                    </td>
                </tr>
                <!--
<tr>
    <td class="colorBlack">视频链接：</td>
    <td><input class="form-control input-sm inputw" type="text" name="video" value=""/></td>
</tr>
                -->
                <tr>
                    <td>缩略图：</td>
