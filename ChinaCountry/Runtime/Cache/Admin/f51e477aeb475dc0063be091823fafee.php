                        ...
                        <!-- <input type="checkbox"   groupid="1"  value="1" checked />查看用户 -->
                                ...
                                <label class="checkbox checkboxW" for="024">
                                    <input type="checkbox" groupid="1" value="24" checked id="024" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        添加备份                                </label>
                                                                                            <!-- <input type="checkbox"    groupid="1"  value="25" />查看分类 -->
                                <label class="checkbox checkboxW" for="025">
                                    <input type="checkbox" groupid="1" value="25" id="025" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看分类                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="26" />添加分类 -->
                                <label class="checkbox checkboxW" for="026">
                                    <input type="checkbox" groupid="1" value="26" id="026" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加分类                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="27" />编辑分类 -->
                                <label class="checkbox checkboxW" for="027">
                                    <input type="checkbox" groupid="1" value="27" id="027" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑分类                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="1"  value="28" />查看新闻 -->
                                ...
                                <label class="checkbox checkboxW" for="029">
                                    <input type="checkbox" groupid="1" value="29" id="029" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        添加新闻                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="30" />编辑新闻 -->
                                <label class="checkbox checkboxW" for="030">
                                    <input type="checkbox" groupid="1" value="30" id="030" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑新闻                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="31" />查看视频 -->
                                <label class="checkbox checkboxW" for="031">
                                    <input type="checkbox" groupid="1" value="31" id="031" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看视频                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="32" />添加视频 -->
                                <label class="checkbox checkboxW" for="032">
                                    <input type="checkbox" groupid="1" value="32" id="032" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加视频                                </label>                            <br />                                <!-- <input type="checkbox"    groupid="1"  value="33" />编辑视频 -->
                                ...
                                <label class="checkbox checkboxW" for="035">
                                    <input type="checkbox" groupid="1" value="35" id="035" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        添加轮播图                                </label>                                                            <!-- <input type="checkbox"    groupid="1"  value="36" />编辑轮播图 -->
                                <label class="checkbox checkboxW" for="036">
                                    <input type="checkbox" groupid="1" value="36" id="036" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
