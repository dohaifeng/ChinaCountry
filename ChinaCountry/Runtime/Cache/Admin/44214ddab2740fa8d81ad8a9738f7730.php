    ...
    <body>
        <form method='post' action='/chinacountry/index.php/Admin/Settings/Update'>
            <table class="table tableW">
                ...
                <tr>
                    <td>上次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='logined' value='2016-08-24 14:16:06'disabled /></td>
                </tr>
                <tr>
                    <td>本次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='login' value='2016-08-24 14:16:06' disabled /></td>
                </tr>
                <tr>
                    <td>登陆次数</td>
                    <td><input class="form-control input-sm inputw" type='text' name='times' value='2016-08-24 14:16:06' disabled /></td>
                </tr>
                <tr>
