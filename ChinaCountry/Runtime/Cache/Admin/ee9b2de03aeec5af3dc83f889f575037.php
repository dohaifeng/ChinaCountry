    ...
    <div class="blWrap clearfix">
        ...
        <div class="top">
            ...
            <ul class="user">
                ...
                <li onclick="window.open.location.href='/chinacountry/index.php/home/index/index.html'">前台首页</li>
    ...
    <body>
        <table class="table tableW">
            ...
            <tr>
                ...
                <td class="td1">2016-08-18 15:11:04</td>
            </tr>
            <tr>
                <td class="td2">上次登录时间</td>
                <td class="td1">2016-08-18 13:08:48</td>
            </tr>
            <tr>
                <td class="td2">累计登录</td>
                <td class="td1">29 次</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="td1">2016年8月18日 15:29:56</td>
            </tr>
            <tr>
