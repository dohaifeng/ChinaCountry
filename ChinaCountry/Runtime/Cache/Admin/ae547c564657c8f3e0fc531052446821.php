                        ...
                        <!-- <input type="checkbox"   groupid="19"  value="1" checked />查看用户 -->
                                ...
                                <label class="checkbox checkboxW" for="128">
                                    <input type="checkbox" groupid="19" value="28" checked id="128" data-toggle="checkbox" class="custom-checkbox">
                                        ...
                                        查看新闻                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="29" checked />添加新闻 -->
                                <label class="checkbox checkboxW" for="129">
                                    <input type="checkbox" groupid="19" value="29" checked id="129" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加新闻                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="30" checked />编辑新闻 -->
                                <label class="checkbox checkboxW" for="130">
                                    <input type="checkbox" groupid="19" value="30" checked id="130" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑新闻                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="31" checked />查看视频 -->
                                <label class="checkbox checkboxW" for="131">
                                    <input type="checkbox" groupid="19" value="31" checked id="131" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看视频                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="32" checked />添加视频 -->
                                <label class="checkbox checkboxW" for="132">
                                    <input type="checkbox" groupid="19" value="32" checked id="132" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加视频                                </label>
                                                            <br /><!-- <input type="checkbox"   groupid="19"  value="33" checked />编辑视频 -->
                                <label class="checkbox checkboxW" for="133">
                                    <input type="checkbox" groupid="19" value="33" checked id="133" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        编辑视频                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="34" checked />查看轮播图 -->
                                <label class="checkbox checkboxW" for="134">
                                    <input type="checkbox" groupid="19" value="34" checked id="134" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        查看轮播图                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="35" checked />添加轮播图 -->
                                <label class="checkbox checkboxW" for="135">
                                    <input type="checkbox" groupid="19" value="35" checked id="135" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
                                        添加轮播图                                </label>
                                                            <!-- <input type="checkbox"   groupid="19"  value="36" checked />编辑轮播图 -->
                                <label class="checkbox checkboxW" for="136">
                                    <input type="checkbox" groupid="19" value="36" checked id="136" data-toggle="checkbox" class="custom-checkbox">
                                        <span class="icons">
                                            <span class="icon-unchecked colorGray"></span>
                                            <span class="icon-checked colorGreen"></span>
                                        </span>
