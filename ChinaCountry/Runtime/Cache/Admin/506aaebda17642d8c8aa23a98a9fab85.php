    ...
    <body>
        <form method='post' action='/chinacountry/index.php/Admin/User/Update'>
            <table class="table tableW">
                ...
                <tr>
                    <td>上次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='logined' value='2016-08-18 13:08:48'disabled /></td>
                </tr>
                <tr>
                    <td>本次登陆</td>
                    <td><input class="form-control input-sm inputw" type='text' name='login' value='2016-08-18 15:11:04' disabled /></td>
                </tr>
                <tr>
                    <td>登陆次数</td>
                    <td><input class="form-control input-sm inputw" type='text' name='times' value='1970-01-01 08:00:29' disabled /></td>
                </tr>
                <tr>
