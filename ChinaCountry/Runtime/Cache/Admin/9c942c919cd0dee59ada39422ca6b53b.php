...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body>
        <table class="table tableW">
            <form action="/chinacountry/index.php/Admin/Settings/insert" method="post">
                <input type='hidden' name='parentid' value='0' />
                <input type='hidden' name='path' value='0'/>
                <tr>
                    <td class="th" colspan="5">类别列表 | <a class="colorBlue" href='javascript:void 0;' name="addClassify">添加类别</a></td>
                </tr>
                <tr class="trHide">
                    <td class="border_none">#</td>
                    <td class="border_none text_right paddingTop1">分类名称：</td>
                    <td class="border_none tdLittle7"><input class="form-control input-sm inputw" type="text" name="name" /></td>
            ...
            <tr class="tableTop">
                ...
                <th class="tdLittle6 colorGray">描述</th>
                <th class="text_left colorGray">操作</th>
            </tr>
            <tr>
                    <td class="paddingTop2">CCTV 《美丽中国乡村行》 栏目官方网站</td>
                    <td class="paddingTop2">美丽中国乡村行,CCTV美丽中国乡村行,CCTV7美丽中国乡村行,中央电视台美丽中国乡村行栏目</td>
                    <td class="paddingTop2">《美丽中国乡村行》栏目官方网站，提供CCTV7《美丽中国乡村行》栏目视频预告、点播、栏目动态等内容。</td>
                    <td class="text_left">
                        <a href="/chinacountry/index.php/admin/settings/index/id/1.html" class="blue">编辑</a>
