...
<html>
    ...
    <head lang="en">
        ...
        <title>精彩预告 - <?php echo ($site["0"]["title"]); ?></title>
        ...
        <link rel="stylesheet" href="/chinacountry/Public/Home/css/advanceNotice.css"/>
    ...
    <section>
        ...
        <div class="float-left">
            ...
            <div class="classify">
                ...
                <?php if(is_array($foreshow)): foreach($foreshow as $key=>$tmp): ?><div class="pro-footer">
                        <div class="pro-video">
                            <a href="<?php echo U('Content/index',array("id" => $tmp['id']));?>">
                                <div class="float-left">
                            ...
                            <div class="media-body">
                                <a href="<?php echo U('Content/index',array("id" => $tmp['id']));?>">
                                    <h4 class="media-heading"><?php echo ($tmp["title"]); ?> </h4>
                                </a>
                                <a href="<?php echo U('Content/index',array("id" => $tmp['id']));?>">
                                    <?php echo (truncate_cn($tmp['introduce'],120)); ?>【MORE】
                                    <p><?php echo (date('Y-m-d H:i:s',(isset($tmp["date"]) && ($tmp["date"] !== ""))?($tmp["date"]):time())); ?></p>
                                </a>
                            </div>
                        </div>
...
<script src="/chinacountry/Public/Home/js/advanceNotice.js"></script>
</html>