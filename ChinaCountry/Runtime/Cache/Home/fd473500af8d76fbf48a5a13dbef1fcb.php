...
<!-- TODO 顶部大图-->
        ...
        <section>
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo U('dynamic/index');?>">栏目动态</a></li>
            ...
            <div class="float-left">
                ...
                <div class="classify">
                    ...
                    <div class="pro-footer">
                        <span>上一篇 ： <a href="<?php echo U('Content/newsDetails',array("id" => $up_id));?>"><?php echo ($up); ?></a></span>
                        <br/>
                        <span>下一篇 ： <a href="<?php echo U('Content/newsDetails',array("id" => $next_id));?>"><?php echo ($next); ?></a></span>
