...
<html>
    ...
    <head lang="en">
        ...
        <title>栏目动态 - <?php echo ($site["0"]["title"]); ?></title>
        ...
        <link rel="stylesheet" href="/chinacountry/Public/Home/css/dynamicColumn.css"/>
        ...
        <div class="float-left">
            ...
            <div class="classify">
                ...
                <div class="pro-footer pro-dm">
                    <?php if(is_array($news)): foreach($news as $key=>$tmp): ?><a href="<?php echo U('Content/newsDetails',array("id" => $tmp['id']));?>">
                            <div class="textRow">
                                <div class="float-left">
                                    <span><?php echo ($tmp["title"]); ?></span>
                                </div>
                                <div class="float-right">
                                    <span><?php echo (date('Y-m-d',(isset($date["date"]) && ($date["date"] !== ""))?($date["date"]):time())); ?></span>
                                </div>
                            </div>
...
<script src="/chinacountry/Public/Home/js/dynamicColumn.js"></script>
</html>