...
<head lang="en">
    ...
    <title>团队档案 - <?php echo ($site["0"]["title"]); ?></title>
    ...
    <link rel="stylesheet" href="/chinacountry/Public/Home/css/TeamFiles.css"/>
            ...
            <div class="classify teamA">
                <div class="teamC" id="jumpBianDao">
                    ...
                    <div class="teamB float-left">
                        <img src="/chinacountry/Public/Home/img/peoples/bianDao/huanjiangping.jpg"/>
                        <p>黄嘉平</p>
                        <p>制片人 导演</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-middle">
                        <img src="/chinacountry/Public/Home/img/peoples/bianDao/jiangbo.jpg"/>
                        <p>姜波</p>
                        <p>编导</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/bianDao/qiujie.jpg"/>
                        <p>邱杰</p>
                        <p>编导</p>
                        <div class="fadeAnimate"></div>
                    </div>
                ...
                <div class="teamC" id="jumpSheXiang">
                    ...
                    <div class="teamB float-left">
                        <img src="/chinacountry/Public/Home/img/peoples/zhuChiRen/xuxiaoqing.jpg"/>
                        <p>徐小晴</p>
                        <p>主持人</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-middle">
                        <img src="/chinacountry/Public/Home/img/peoples/zhuChiRen/songwenbin.jpg"/>
                        <p>宋文彬</p>
                        <p>主持人</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/zhuChiRen/luyinliang.jpg"/>
                        <p>陆银亮</p>
                        <p>摄像</p>
                        <div class="fadeAnimate"></div>
                    </div>
                ...
                <div class="teamC" id="jumpXingZheng">
                    ...
                    <div class="teamB float-left">
                    <img src="/chinacountry/Public/Home/img/peoples/xingZheng/zhenzheng.jpg"/>
                    <p>郑振</p>
                    <p>总监</p>
                    <div class="fadeAnimate"></div>
                    ...
                    <div class="teamB float-middle">
                    <img src="/chinacountry/Public/Home/img/peoples/xingZheng/tangmanyang.jpg"/>
                    <p>唐扬满</p>
                    <p>总监助理</p>
                    <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/xingZheng/tangrucai.jpg"/>
                        <p>唐如才</p>
                        <p>栏目组副主任</p>
                        <div class="fadeAnimate"></div>
                    </div>
                ...
                <div class="teamC teamD">
                    <div class="teamB float-left">
                        <img src="/chinacountry/Public/Home/img/peoples/xingZheng/zhongjing.jpg"/>
                        <p>钟晶</p>
                        <p>栏目组副主任</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-middle">
                        <img src="/chinacountry/Public/Home/img/peoples/xingZheng/shenjinxiang.jpg"/>
                        <p>沈金祥</p>
                        <p>行政顾问</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/xingZheng/zhudongming.jpg"/>
                        <p>朱东明</p>
                        <p>驾驶员</p>
                        <div class="fadeAnimate"></div>
                    </div>
                ...
                <div class="teamC" id="jumpWaiLian">
                    ...
                    <div class="teamB float-left">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/huangdongmei.jpg"/>
                        <p>黄冬梅</p>
                        <p>外联主任</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-middle">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/zhuzhuqing.jpg"/>
                        <p>朱祝青</p>
                        <p>外联主任</p>
                        <div class="fadeAnimate"></div>
                    ...
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/shenqing.jpg"/>
                        <p>沈卿</p>
                        <p>外联</p>
                        <div class="fadeAnimate"></div>
                    </div>
                ...
                <div class="teamC teamD">
                    <div class="teamB float-left">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/songlin.jpg"/>
                        <p>宋林</p>
                        <p>外联</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-middle">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/yudaxiang.jpg"/>
                        <p>于大祥</p>
                        <p>外联</p>
                        <div class="fadeAnimate"></div>
                    </div>
                    <div class="teamB float-right">
                        <img src="/chinacountry/Public/Home/img/peoples/waiLian/lulifu.jpg"/>
                        <p>卢立富</p>
                        <p>外联</p>
                        <div class="fadeAnimate"></div>
                    </div>
...
<script src="/chinacountry/Public/Home/js/TeamFiles.js"></script>
</html>