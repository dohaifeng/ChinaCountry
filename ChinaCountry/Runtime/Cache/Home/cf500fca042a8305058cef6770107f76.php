...
<html>
    ...
    <head lang="en">
        ...
        <title>联系我们 - <?php echo ($site["0"]["title"]); ?></title>
        ...
        <link rel="stylesheet" href="/chinacountry/Public/Home/css/contactUs.css"/>
        ...
        <div class="float-left">
            ...
            <div class="classify">
                ...
                <div class="pro-footer pro-jingCai">
                    ...
                    <div class="baiduMap">
                        <img src="/chinacountry/Public/Home/img/images/baiduMap.png" class="img-responsive"/>
                    </div>
                </div>
            </div>
            <!-- 精彩预告end-->
...
<script src="/chinacountry/Public/Home/js/contactUs.js"></script>
</html>